...
def create_app(config_class=Config):
    ...
    def add_security_headers(response):
        ...
        ] = "default-src 'self'; script-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net/gh/davidshimjs/qrcodejs@gh-pages/qrcode.min.js https://cdnjs.cloudflare.com/ajax/libs/qrious/4.0.2/qrious.min.js https://cdn.rawgit.com/davidshimjs/qrcodejs/gh-pages/qrcode.min.js https://d3js.org/d3.v7.min.js https://cdn.quilljs.com https://cdn.tailwindcss.com https://unpkg.com https://cdnjs.cloudflare.com/ajax/libs/flowbite/1.6.5/flowbite.min.js https://hcaptcha.com https://*.hcaptcha.com; style-src 'self' 'unsafe-inline' https://unpkg.com/ https://cdn.quilljs.com https://cdn.tailwindcss.com https://fonts.googleapis.com https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css https://cdnjs.cloudflare.com https://hcaptcha.com https://*.hcaptcha.com; font-src 'self' https://fonts.googleapis.com https://fonts.gstatic.com; connect-src 'self' https://unpkg.com https://assets.hcaptcha.com https://hcaptcha.com https://*.hcaptcha.com; frame-src 'self' https://assets.hcaptcha.com https://hcaptcha.com https://*.hcaptcha.com; img-src 'self' https://lh3.googleusercontent.com;"
